  ...
  void init() async {
    ...
    if (sharedPref.getBool(IS_FIRST_TIME) ?? true) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          print('nego el permiso');
        }
      }

      if (permission == LocationPermission.deniedForever) {
        print('lo nego para siempre');
      }
      ...
      // var permissionStatus = await location.requestPermission();
        ...
        if (!appStore.isLoggedIn) {
          ...
          if (sharedPref
              ...
              .isEmptyOrNull) {
            launchScreen(
                context, EditProfileScreen(isGoogle: true), isNewTask: true,
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              Image.asset(
                  ic_logo_white, fit: BoxFit.contain, height: 150, width: 150),
              SizedBox(height: 16),
