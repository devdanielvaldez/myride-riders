                      ...
                      Row(
                        children: [
                          ...
                          inkWellWidget(
                            ...
                            child: Text(language.rememberMe, style: primaryTextStyle(size: 12)),
                          ),
                        ],
                      ),
                      inkWellWidget(
                        ...
                        child: Text(language.forgotPassword, style: primaryTextStyle(size: 12)),
                      ),
                    ],
                  ),
                  SizedBox(height: 16),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "Aceptar Politicas de Privacidad", style: primaryTextStyle(size: 12)),
                              TextSpan(
