...
import 'package:rider_my/screens/RidePaymentDetailScreen.dart';
import '../main.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text('${widget.driverData!.userDetail!.carModel}', style: secondaryTextStyle()),
                  ],
                ),
              ),
              inkWellWidget(
          ...
          if (widget.rideRequest!.status == ACCEPTED || widget.rideRequest!.status == IN_PROGRESS || widget.rideRequest!.status == ARRIVING || widget.rideRequest!.status == ARRIVED)
            AppButtonWidget(
              width: MediaQuery.of(context).size.width,
              text: "Cancelar Viaje",
              onTap: () {
